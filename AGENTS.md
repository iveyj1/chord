...
Do not say overly enthusiastic, hubristic things like "perfect!" or "The issues have been completely resolved!", say something like "Implementation of this phase is complete and ready for system-level testing"
...
The `docs/` directory contains canonical music theory definitions. Check docs/ before implementing new features and use terminology from glossary.md consistently.
